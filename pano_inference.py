...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", default='checkpoints/eval_agd.pth', help="ARLP checkpoint path")
    parser.add_argument("--det-backend", default="yolo_world", help="Detector backend name")
    parser.add_argument("--det-model", default="yolov8s-worldv2.pt", help="Detector model path or model name")
    parser.add_argument("--det-classes", default='sofa', help="Comma-separated open-vocabulary detection classes")
    ...
    parser.add_argument("--output-dir", default='runs/pano_inference', help="Directory to save outputs")
